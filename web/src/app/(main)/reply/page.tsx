...
export default function ReplyPage() {
  ...
  if (pageState === 'empty') {
    return (
      <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-margin-sm pt-6 pb-32">
        <div className="bg-surface-container-lowest rounded-xl p-margin-lg flex flex-col items-center text-center shadow-[0_4px_20px_0_rgba(147,74,46,0.04)] w-full max-w-[480px]">
          <div className="w-56 h-56 mb-margin-md rounded-full overflow-hidden flex items-center justify-center bg-surface-container-low border border-surface-variant relative">
            <img
              src={EMPTY_MAILBOX_URL}
              alt="빈 우편함"
          ...
          <button
            ...
            className="bg-primary text-on-primary font-label-sm text-label-sm rounded-full px-8 py-4 min-w-[200px] hover:opacity-80 transition-opacity shadow-sm flex items-center justify-center gap-2 active:scale-95"
          >
            메인으로 돌아가기
          </button>
        </div>
          ...
          <div className="mb-margin-lg relative">
            <div className="w-48 h-48 rounded-full bg-surface-container flex items-center justify-center shadow-[0_20px_40px_rgba(147,74,46,0.08)]">
              <span
                ...
                style={{ fontSize: 80, fontVariationSettings: "'FILL' 0" }}
              >
                send
              </span>
            </div>
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
      {/* 서브 헤더 */}
      <header className="fixed top-16 left-0 w-full z-40 flex justify-between items-center px-margin-sm h-14 max-w-container-max-width mx-auto bg-surface/80 backdrop-blur-md">
        <button
          onClick={() => router.back()}
      ...
      {/* 메인 콘텐츠 */}
      <main className="flex-grow w-full max-w-container-max-width mx-auto px-margin-sm pt-[7.5rem] pb-32 flex flex-col items-center relative z-10">
        {/* 고민 카드 */}
        <article className="w-full bg-surface-container-lowest rounded-xl p-8 mb-margin-md shadow-[0_4px_20px_0_rgba(147,74,46,0.04)] flex flex-col max-h-[40vh] overflow-y-auto">
          <div className="flex items-center gap-3 mb-6 opacity-80">
            ...
            <span className="font-label-sm text-label-sm text-outline-variant ml-auto">오늘</span>
          </div>
        ...
        <div className="w-full flex items-center justify-center mb-margin-md opacity-30">
          ...
          <span
            className="material-symbols-outlined mx-4 text-outline"
        ...
        <section className="w-full flex-grow flex flex-col relative">
          ...
          <textarea
            ...
            className="w-full flex-grow min-h-[200px] bg-transparent border-0 resize-none font-body-lg text-body-lg text-on-surface placeholder:text-outline-variant focus:ring-0 p-0 leading-relaxed outline-none"
          />
      ...
      {/* 하단 버튼 */}
      <div className="fixed bottom-16 md:bottom-0 left-0 w-full bg-gradient-to-t from-surface via-surface to-transparent pt-12 pb-6 px-margin-sm z-40">
        <div className="max-w-container-max-width mx-auto">
          <button
            onClick={handleSubmitReply}
            disabled={!replyContent.trim() || submitting}
            className="w-full h-14 bg-primary text-on-primary font-title-md text-title-md rounded-full shadow-sm hover:shadow-md transition-shadow flex items-center justify-center gap-2 shadow-[0_4px_20px_0_rgba(147,74,46,0.04)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
